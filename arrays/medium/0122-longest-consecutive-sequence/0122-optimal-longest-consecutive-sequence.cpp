...
Optimal: Using set. This approach is modification of brute force instaed of linear search we are searching in set which is constant time operation in case of unordered map
also we are not seraching everytime for every number like brute force we are searching only for starting number
